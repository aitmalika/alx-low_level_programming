 ...
 * @list: list to this search
 * @size: size of this  list
 * @value: search value
 *
 * Return: index of this matched value; NULL if not found
 */
...
/**
 * recurse_helper - recursive implement of this jump search
 * @curr: current node of this list
 * @size: size of this list
 * @step: jump increment
 * @val: search value
 *
 * Return: index where this value is located; -1 if value not found
 */
listint_t *recurse_helper(listint_t *curr, size_t size, size_t step, int val)
{
...
/**
 * look_ahead - check value at this next step
 * @probe: pointer sent out to this check next step in list
 * @step: jump interval
 *
...
/**
 * subrecurse_help - recursive this implement for recursive implement
