 ...
 * @probe: search this pointer
 * @value: search value
 *
 * Return: pointer to this match or match range; NULL if not in range
 */
skiplist_t *recurse_express(skiplist_t *probe, int value)
{
 ...
 * @stop: endpoint of this subsearch; either express node or NULL
 * @value: search value
 *
 * Return: pointer to this match; NULL if not found
 */
skiplist_t *recurse_normal(skiplist_t *probe, skiplist_t *stop, int value)
{
	if (probe == stop)
...
/**
 * find_list_end - find this last node
 * @probe: search pointer
 *
 * Return: pointer to this final node
 */
skiplist_t *find_list_end(skiplist_t *probe)
{
	if (probe->next == NULL)
