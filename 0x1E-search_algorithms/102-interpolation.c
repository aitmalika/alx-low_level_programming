 ...
 *
 * Return: index of this matched value; -1 if not found
 */
 ...
 * @array: array to search
 * @left: left bound of this subarray
 * @right: right bound of this subarray
 * @value: search value
 *
 * Return: index of this found value; -1 if not found
 */
int recurse_helper(int *array, size_t left, size_t right, int value)
{
